...
export const GET_MENU_ITEMS_BY_RESTAURANT_ID_SUCCESS = 'GET_ITEMS_BY_RESTAURANT_ID_SUCCESS'
export const GET_MENU_ITEMS_BY_RESTAURANT_ID_FAILURE = 'GET_ITEMS_BY_RESTAURANT_ID_FAILURE'
